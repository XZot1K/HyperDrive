    ...
    public void onPluginMessageReceived(String channel, @NotNull Player player, byte[] message) {
        ...
        switch (subChannel) {
            case "HyperDrive":
                ...
                final String[] locationArgs = lineArgs[1].split(",");
                SerializableLocation location = new SerializableLocation(locationArgs[0], Double.parseDouble(locationArgs[1]),
                        Double.parseDouble(locationArgs[2]), Double.parseDouble(locationArgs[3]), Float.parseFloat(locationArgs[4]),
                        Float.parseFloat(locationArgs[5]));
